...
import argparse
from utils.train_eval_test import train, test, evaluate
...
def main():
    ...
    parser.add_argument("--train_seg_y_dir", default='{}/data_processing/datasets/train_set.seg_y.txt'.format(BASE_DIR),
                        help="train_seg_y_dir")
    parser.add_argument("--eval_seg_x_dir", default='{}/data_processing/datasets/val_set.seg_x.txt'.format(BASE_DIR),
                        help="val_seg_x_dir")
    parser.add_argument("--eval_seg_y_dir", default='{}/data_processing/datasets/val_set.seg_y.txt'.format(BASE_DIR),
                        help="val_seg_y_dir")
    parser.add_argument("--test_seg_x_dir", default='{}/data_processing/datasets/test_set.seg_x.txt'.format(BASE_DIR),
                        help="test_seg_x_dir")
    parser.add_argument("--vocab_path", default='{}/data_processing/datasets/vocab.txt'.format(BASE_DIR), help="Vocab path")
    parser.add_argument("--word2vec_output", default='{}/data_processing/datasets/word2vec.txt'.format(BASE_DIR), help="Vocab path")
    parser.add_argument("--log_file", help="File in which to redirect console outputs", default="", type=str)
    parser.add_argument("--test_save_dir", default='{}/data_processing/datasets/'.format(BASE_DIR), help="test_save_dir")
    parser.add_argument("--test_x_dir", default='{}/data_processing/datasets/AutoMaster_TestSet.csv'.format(BASE_DIR),
                        help="test_x_dir")
