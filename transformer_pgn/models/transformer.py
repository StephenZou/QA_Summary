...
from transformer_pgn.encoders.self_attention_encoder import EncoderLayer
from transformer_pgn.decoders.self_attention_decoder import DecoderLayer
from transformer_pgn.layers.transformer import MultiHeadAttention, Embedding
from pgn_model.utils.decoding import calc_final_dist
...
class Decoder(tf.keras.layers.Layer):
    ...
    def call(self, x, enc_output, training, look_ahead_mask, padding_mask):
        ...
        context = tf.reshape(enc_output, (enc_out_shape[0], enc_out_shape[1], self.num_heads, self.depth))
